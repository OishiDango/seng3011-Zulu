...
class GeminiSummary:
    response_schema = {
        ...
        "properties": {
            ...
            "potential_threats": {
                ...
                "required": ["high_exposure", "high_severity", "other_relevant_threats"]
            },
            "ignored_alerts": {
                "type": "array",
    ...
    def region_summary(self, alerts:list, location_chain:list, disease_info: dict = {}):
        ...
        prompt =f""" 
            ...
            You can mention if the provided data is insufficient for a conclusion.
            ...
            Pay attention to the publish date of alerts. Today is {date.today()}.
            The location is {location_chain}, carefully ignore alerts only when they obviously unrelated to this location. List all the ignored alerts follow the schema.
            Repeated alerts for the same disease or area may indicate a stronger signal, but do not overstate certainty beyond the provided evidence.

            Your task is to create a concise, objective summary for travel-risk interpretation by:
